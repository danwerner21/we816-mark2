...
1252 PRINT"  THE GALAXY BEFORE THEY CAN"
1253 PRINT"  ATTACK FEDERATION HEADQUARTERS"
1260 PRINT"  ON STARDATE";T0+T9;".  THIS GIVES"
1261 PRINT"  YOU";T9;" DAYS.  THERE";X0$;" ";B9
1272 PRINT"  STARBASE";X$;" IN THE GALAXY FOR"
1273 PRINT"  RESUPPLYING YOUR SHIP."
1280 PRINT:INPUT "<PRESS ENTER TO START>";AA$
...
1471 PRINT"LOCATED IN THE GALACTIC"
1472 PRINT"QUADRANT, '";G2$;"'.":GOTO 1500
...
2030 PRINT" YOUR SHIP IN SPACE. YOU HAVE"
2031 PRINT"INSUFFICIENT MANEUVERING ENERGY,";
...
3790 IFX5=0THEN3860
3800 PRINT"LT. UHURA REPORTS FROM STARFLEET:"
3810 PRINT" PERMISSION TO ATTEMPT CROSSING OF"
3820 PRINT" GALACTIC PERIMETER IS HEREBY *DENIED*."
3821 PRINT"  SHUT DOWN YOUR ENGINES.'"
3830 PRINT"CHIEF ENGINEER SCOTT REPORTS"
3831 PRINT" 'WARP ENGINES SHUT DOWN"
3840 PRINT"  AT SECTOR";S1;",";S2
3841 PRINT"  OF QUADRANT";Q1;",";Q2;".'"
...
3931 PRINT"COMPLETE THE MANEUVER."
...
4271 PRINT" 'SENSORS SHOW NO ENEMY SHIPS IN THIS"
...
4550 PRINTK(I,2):IFK(I,3)<=0THENPRINT"*** KLINGON DESTROYED ***":
4551 GOTO4580
...
4791 PRINT" 'INCORRECT COURSE DATA, SIR!'"
4800 GOTO1990
...
5381 PRINT"STARDATES AT HARD LABOR ON CYGNUS 12!!"
5390 GOTO 6270
...
5601 PRINT" 'THIS IS NOT THE FEDERATION TREASURY.'"
5610 PRINT"<SHIELDS UNCHANGED>":GOTO1990
5630 E=E+S-X:S=X:PRINT"DEFLECTOR CONTROL ROOM REPORT:"
5660 PRINT"  'SHIELDS NOW AT";INT(S)
5661 PRINT" UNITS PER YOUR COMMAND.'":GOTO1990
...
5811 PRINT"REPAIRS TO YOUR SHIP;"
5820 PRINT"ESTIMATED TIME TO REPAIR:";.01*INT(100*D3);
5821 PRINT" STARDATES."
...
6172 PRINT"DAMAGED BY THE HIT'"
6200 NEXTI:RETURN
6210 REM END OF GAME
6220 PRINT"IT IS STARDATE";T:GOTO 6270
6240 PRINT:PRINT"THE ENTERPRISE HAS BEEN DESTROYED."
6250 PRINT"THE FEDERATION WILL BE CONQUERED.":GOTO 6220
6270 PRINT"THERE WERE";K9;" KLINGON BATTLE"
6280 PRINT"CRUISERS LEFT AT THE END OF "
6281 PRINT"YOUR MISSION."
6290 PRINT:PRINT:IFB9=0THEN6360
6310 PRINT"THE FEDERATION IS IN NEED OF A NEW "
6320 PRINT"STARSHIP COMMANDER FOR A SIMILAR "
6321 PRINT"MISSION -- IF THERE IS A VOLUNTEER,LET"
6330 INPUT"HIM STEP FORWARD AND ENTER 'AYE':";A$:IFA$="AYE"THEN10
6360 END
6370 PRINT"CONGRULATION, CAPTAIN!  THEN LAST "
6380 PRINT"KLINGON BATTLE CRUISER MENACING THE "
6381 PRINT"FDERATION HAS BEEN DESTROYED.":PRINT
...
6770 PRINT" STARDATE ";INT(T*10)*.1;", CONDITION ";C$
6771 PRINT"  QUADRANT ";Q1;",";Q2;"   SECTOR ";S1;",";S2
6772 O1$="---------------------------------":PRINTO1$:FORI=1TO8
6820 FORJ=(I-1)*24+1TO(I-1)*24+22STEP3:PRINT" ";MID$(Q$,J,3);:NEXTJ:PRINT
6830 NEXTI:PRINT:PRINT O1$
6840 PRINT" PHOTON TORPEDOES  ";INT(P)
6850 PRINT" TOTAL ENERGY      ";INT(E+S)
...
7360 PRINT"AVAILABLE FROM LIBRARY-COMPUTER:"
...
7545 PRINT"FOR QUADRANT";Q1;",";Q2
7546 PRINT
7550 PRINT"     1   2   3   4   5   6   7   8"
7560 O1$="     --- --- --- --- --- --- --- ---"
7570 PRINTO1$:FORI=1TO8:PRINTI;:IFH8=0THEN7740
7630 PRINT"  ";:FORJ=1TO8:PRINT" ";:IFZ(I,J)=0THENPRINT"***";:GOTO7720
7700 PRINTRIGHT$(STR$(Z(I,J)+1000),3);
7720 NEXTJ:GOTO7850
7740 Z4=I:Z5=1:GOSUB9030:J0=INT(12-.5*LEN(G2$))-2:PRINTTAB(J0);G2$;
7800 Z5=5:GOSUB 9030:J0=INT(35-.5*LEN(G2$))-4:PRINTTAB(J0);G2$;
...
7990 GOTO5690
8010 PRINT"YOUR STUPIDITY HAS LEFT YOU ON YOUR "
8020 PRINT"OWN IN THE GALAXY -- YOU HAVE NO "
8021 PRINT"STARBASES LEFT!":GOTO5690
8060 REM TORPEDO, BASE NAV, D/D CALCULATOR
8070 IFK3<=0THEN4270
8080 X$="":IFK3>1THENX$="S"
8090 PRINT"FROM ENTERPRISE TO KLINGON BATTLE"
8091 PRINT"CRUSER";X$
